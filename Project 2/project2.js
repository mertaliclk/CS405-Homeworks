...
class MeshDrawer {
	...
	setMesh(vertPos, texCoords, normalCoords) {
		...
		//creating a buffer data to draw normal buffer to update light coordinates.
	...
	draw(trans) {
		...
		// change the light position for normal buffer
        gl.bindBuffer(gl.ARRAY_BUFFER, this.normalbuffer);
	...
	setTexture(img) {
		...
		if (isPowerOf2(img.width) && isPowerOf2(img.height)) {
			...
			// CLAMP_TO_EDGE used for power of two texture as wanted
	
			// Texture filtering
			gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
			gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR);
			// LINEAR used for power of two texture as wanted
		}
	...
	enableLighting(show) {
		 ...
		 */
		//updated similarly to showTexture
        gl.useProgram(this.prog);
